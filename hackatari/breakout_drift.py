...
parser.add_argument('-s', '--stength', type=int, choices=[0, 1, 2], default=1,
                    help='Set the drift direction (0, 1, or 2) - 0 is no drift, 1 is medium, 2 is high')
...
- STRENGTH = 1 is a medium drift of 2 pixles per ram step,
