        ...
        if mod.startswith("s"):
            ...
            if mod[-1].isdigit():
                ...
                if mod_n < 0 or mod_n > 4:
                    raise ValueError(
                        "Invalid color for player, choose value 0-4 [black, white, red, blue, green]"
                    )
            else:
                raise ValueError(
            ...
            if mod[-1].isdigit():
                ...
                if mod_n < 0 or mod_n > 4:
                    raise ValueError(
                        "Invalid color for block, choose value 0-4 [black, white, red, blue, green]"
                    )
            else:
                raise ValueError(
                    "Append value 0-4 [black, white, red, blue, green] to your color mod-argument"
